...
void test_NFC_test_writeUserMemory_expect_correct(void)
{

    uint8_t expect[1] = {0x12};
    uint8_t data[1] = {0x12};

    I2CWrite_ExpectWithArray(NFC_USERMEMORY, 0x1234, expect,1,1);

    writeUserMemory(0x1234,data,1);
}
